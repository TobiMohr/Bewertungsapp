<template>
  <div class="p-8">
    <h1 class="text-2xl font-bold mb-6">User Import & Export</h1>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <!-- Export Section -->
      <div class="p-6 bg-white rounded-lg shadow-md">
        <h2 class="text-xl font-semibold mb-4">Export Users</h2>
        <p class="text-gray-600 mb-4">
          Click below to export all users and evaluations as a CSV file.
        </p>
      ...
      <!-- Import Section -->
      <div class="p-6 bg-white rounded-lg shadow-md">
        <h2 class="text-xl font-semibold mb-4">Import Users</h2>
        <p class="text-gray-600 mb-4">
          Choose a CSV file containing users and click “Import”.
        </p>
